...
<div class="container">
    <div class="row">
        <div class="span9 block_right span-t8 plr10 span-m12" id="ajax_sort">
            ...
            <div class="clear"></div>
            @if($list_pro_child->count()>0)
            <div class="block_prd">
                <div class="row">
                    @foreach ( $list_pro_child as  $item)
                    @php
        ...
        <form method="POST" action="" id="filter1" data-url="{{ url('product/filter1/ajax') }}" data-id="{{ $id }}">
