    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                <form action="{{route('cat/update' , $cat_post->id)}}" method="POST">
                    @csrf
                        <div class="form-group">
                            ...
                            <div class="form-text text-danger">{{$message}}</div>
                                @enderror
                        <input class="form-control" type="text" value="{{$cat_post->name}}" name="name" id="name">
                        </div>
                        <div class="form-group">
                            <label for="name">Slug</label>
                            <input class="form-control" value="{{$cat_post->slug}}" type="text" name="slug" id="name">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="" name="categary">
                                ...
                                @if($value->id == $cat_post->parent_id )
